                ...
                <section class="card col-lg-5 col-sm-12 col-md-8 border-0  shadow-lg">
                    <div class="card-body px-5">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" name="name" placeholder="Your Name" class="form-control" value="<?=$row['name']?>" required="">
                        </div>
                        <div class="mb-1">
                            <label class="form-label">Email address</label>
                            <input type="email" name="email" placeholder="Your email" class="form-control" value="<?=$row['email']?>" required="">
                        </div>
                        <div class="mb-1">
                            <label class="form-label">Phone</label>
                            <input placeholder="Phone Number" name="phone" type="text" class="form-control" value="<?=$row['phone']?>" required="">
                        </div>
                        
                        <div class="d-inline-flex justify-content-center mb-2 col-12">
                            <input type="submit" name="submit" class="btn btn-success col-12 mt-2  my-auto" value="Update">
                        </div>
                        </form>
                    </div>
                </section>
